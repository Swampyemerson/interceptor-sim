...
case "$ARM" in
  ...
  # HEIGHT-REFERENCE A/B (docs/vertical_channel_prereg.md section 9, pre-registered
  ...
  # POINTING, ALIGNED arms (docs/pointing_prereg.md amendment): nose pointed before the dash.
  PCAMA)   EXTRA="$BASE --dash-accel-aware-lead --alt-ref-offset-m -0.207 --dash-prealign-yaw"; N=8; DIRS=both;;
  PYAWA)   EXTRA="$BASE --dash-accel-aware-lead --alt-ref-offset-m -0.207 --dash-prealign-yaw --dash-yaw-to-predicted-los"; N=8; DIRS=both;;
  PYAWTA)  EXTRA="$BASE --dash-accel-aware-lead --alt-ref-offset-m -0.207 --dash-prealign-yaw --dash-yaw-to-predicted-los --cam-mount-up-deg 25"; N=8; DIRS=both; WEDGE=25;;
  PDASHA)  EXTRA="$BASE --dash-accel-aware-lead --alt-ref-offset-m -0.207 --dash-prealign-yaw $DASHONLY"; N=8; DIRS=both;;
  PYAWDA)  EXTRA="$BASE --dash-accel-aware-lead --alt-ref-offset-m -0.207 --dash-prealign-yaw --dash-yaw-to-predicted-los $DASHONLY"; N=8; DIRS=both;;
