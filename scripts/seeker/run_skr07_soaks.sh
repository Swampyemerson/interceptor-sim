...
arm qd2_uncapped --mode apriltag --quad-decimate 2.0 --target-fps 143 --allow-no-tag
...
arm qd1_uncapped --mode apriltag --quad-decimate 1.0 --target-fps 143 --allow-no-tag
